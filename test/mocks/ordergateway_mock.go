...
import (
	entity "github.com/tech-challenge-fiap-5soat/tc-ff-kitchen-api/src/core/entity"
...
func (_m *MockOrderGateway) FinishOrder(orderId string) error {
...
// MockOrderGateway_FinishOrder_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'FinishOrder'
type MockOrderGateway_FinishOrder_Call struct {
	*mock.Call
}

// FinishOrder is a helper method to define mock.On call
//   - orderId string
func (_e *MockOrderGateway_Expecter) FinishOrder(orderId interface{}) *MockOrderGateway_FinishOrder_Call {
	return &MockOrderGateway_FinishOrder_Call{Call: _e.mock.On("FinishOrder", orderId)}
}

func (_c *MockOrderGateway_FinishOrder_Call) Run(run func(orderId string)) *MockOrderGateway_FinishOrder_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockOrderGateway_FinishOrder_Call) Return(_a0 error) *MockOrderGateway_FinishOrder_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockOrderGateway_FinishOrder_Call) RunAndReturn(run func(string) error) *MockOrderGateway_FinishOrder_Call {
	_c.Call.Return(run)
	return _c
}
