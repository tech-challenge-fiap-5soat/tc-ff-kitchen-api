...
func (_m *MockOrderUseCase) CreateOrder(order entity.Order) (string, error) {
	ret := _m.Called(order)
...
func (_c *MockOrderUseCase_CreateOrder_Call) Run(run func(order entity.Order)) *MockOrderUseCase_CreateOrder_Call {
...
func (_c *MockOrderUseCase_CreateOrder_Call) RunAndReturn(run func(entity.Order) (string, error)) *MockOrderUseCase_CreateOrder_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockOrderUseCase) UpdateOrder(orderId string, order entity.Order) error {
...
func (_c *MockOrderUseCase_UpdateOrder_Call) Run(run func(orderId string, order entity.Order)) *MockOrderUseCase_UpdateOrder_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(entity.Order))
	})
	return _c
}
...
func (_c *MockOrderUseCase_UpdateOrder_Call) RunAndReturn(run func(string, entity.Order) error) *MockOrderUseCase_UpdateOrder_Call {
	_c.Call.Return(run)
	return _c
}
