...
import (
	...
	coreErrors "github.com/tech-challenge-fiap-5soat/tc-ff-kitchen-api/src/common/errors"
...
func (ad *mongoAdapter[T]) Update(identifier string, data interface{}) (interface{}, error) {
	...
	res, err := ad.collection.UpdateOne(ctx, bson.M{"_id": identifier}, bson.D{{Key: "$set", Value: data}})
